...
public class SingInActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerPage = (TextView) findViewById(R.id.singUp);
        ...
        editTextEmail = (EditText)findViewById(R.id.emailSingIn);
        editTextPassword = (EditText)findViewById(R.id.passwordSingIn);
    }
    ...
    private void UserLogin() {
        ...
        fAuth.signInWithEmailAndPassword(email,password)
            ...
            public void onFailure(@NonNull @org.jetbrains.annotations.NotNull Exception e) {
                Toast.makeText(SingInActivity.this, "Username atau Password anda salah!", Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        df.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                ...
                switch (documentSnapshot.getLong("type").intValue()){
                    case 0:
                        Toast.makeText(SingInActivity.this, "Loggedin Warga successfully", Toast.LENGTH_LONG).show();
                        Log.d(TAG,"Loggedin as customer successfully: ");
                        startActivity(new Intent(getApplicationContext(), MainActivity.class));
                        break;
                    case 1:
                        Toast.makeText(SingInActivity.this, "Loggedin RT successfully", Toast.LENGTH_LONG).show();
